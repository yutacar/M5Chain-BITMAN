...
通常はBMI270が示す重力方向に応じて、8×8の下・右・上・左の辺を地面として扱います。回転中は走らず、屈伸姿勢のまま次の地面へ位置を移し、静止後も現在の地面に足をつけて上下に屈伸します。

地面が切り替わると、屈伸姿勢のまま旧地面の中央から共有する角へ寄り、向きを切り替えて新しい地面の中央へ移る6コマ・約1.6秒の遷移を再生します。
